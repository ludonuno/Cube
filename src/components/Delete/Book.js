...
class Book extends Component {
    ...
    SetBookFieldValues = (book) => {
        ...
        this.props.sagaList.forEach(saga => {if(saga.id === publishingCompanyId) this.saga.value = saga.name})
        this.props.publishingCompanyList.forEach(publishingCompany => {if(publishingCompany.id === sagaId) this.publishingCompany.value = publishingCompany.name})
    }
    ...
    SetBookToEdit = (event) => {
        this.props.bookList.forEach(book => {if(book.id === Number(event.target.value)) this.SetBookFieldValues(book)})
    }
