...
class Company extends Component {
    ...
    LoadDataToFields = () => {
        this.SetCompanyFieldValues(JSON.parse(this.cbDelete.value))
    }
    ...
    render() {
        return ( 
            <React.Fragment>
                ...
                <Form onSubmit={this.DeleteCompany} ref={(form) => this.formRef = form}>
                    <ComboBox header={'Empresa'} list={this.props.companyList} onChange={this.LoadDataToFields} ref={(input) => this.cbDelete = input} />
                    <Form.Group as={Row}> 
